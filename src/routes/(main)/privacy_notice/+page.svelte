...
<div class="w-90% mx-auto shadow-1 glass p-2em">
	...
	<ul>
		...
		<li>
			<p>
				...
				or &quot;Our&quot; in this Agreement) refers to forkread.
			</p>
		</li>
		<li>
			<p>
		...
		<li>
			<p>
				<strong>Country</strong>
				 refers to: Arizona, United States
			</p>
		</li>
		<li>
			<p>
		...
		<li>
			<p>
				...
				Company, to perform services related to the Service or to assist the Company
		...
		<li>
			<p>
				...
				refers to forkread, accessible from
				<a href="forkread.com" rel="external nofollow noopener" target="_blank">
					forkread.com
				</a>
			</p>
		</li>
	...
	<ul>
		<li>
			...
			if You do not accept Cookies, You may not be able to use some parts of our
	...
	<ul>
		...
		<li>
			<p>
				...
				liquidation, or similar proceeding, in which Personal Data held by Us about
	...
	<ul>
		<li>By email: questiton@forkread.com</li>
	</ul>
</div>
